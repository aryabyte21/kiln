"""
vibe_tool.app.synthesis.callback
---------------------------------
Posts synthesis results back to the ARIA webhook.
"""
...
async def notify_success(
    ...
    """POST multipart form with spec.yaml and impl.py to the ARIA webhook.

    Args:
        callback_url: The webhook URL (e.g. http://localhost:8000/tools/register).
        tool_id: The Babel tool ID (e.g. com.aria.tools.weather).
...
async def notify_failure(
    ...
    """POST a JSON error to the ARIA webhook on synthesis failure.

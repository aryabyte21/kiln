"""
vibe_tool.app.models
--------------------
Pydantic models for the vibe_tool API.
"""
...
class ToolInput(BaseModel):
    ...
    type: str = Field(..., description="Babel type: string|integer|float|boolean|enum|array|object")
...
class SynthesizeRequest(BaseModel):
    ...
    callback_url: Optional[str] = Field(None, description="Override default ARIA webhook URL")

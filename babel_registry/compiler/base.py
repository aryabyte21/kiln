...
class BaseAdapter(ABC):
    ...
    def compile(self, tool: BabelTool) -> Any:
        """
        Convert a BabelTool into a native framework object.

        Args:
            tool: The BabelTool from the registry.
    ...
    def _build_json_schema(self, tool: BabelTool) -> dict:
        """

"""
babel/compiler/mistral.py
──────────────────────────
Compiles a BabelTool into Mistral-compatible tool definitions.
...
Usage:
    compiled = runtime.get("com.aria.tools.weather", target="mistral")
...
class MistralAdapter(BaseAdapter):
    ...
    def compile(self, tool: BabelTool) -> CompiledMistralTool:
        """
        Build the Mistral tool definition dict from the BabelToolSpec
